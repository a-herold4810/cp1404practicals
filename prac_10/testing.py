...
def format_phrase(phrase):
    ...
    'It is an ex parrot.'
    >>> format_phrase("This is already capitalized.")
...
def run_tests():
    ...
    assert car_default_fuel.fuel == 0, "Car default fuel should be 0"
    # Note that Car's __init__ function sets the fuel in one of two ways:
    # using the value passed in or the default
    # You should test both of these
    assert format_phrase("hello") == "Hello."
    assert format_phrase("it is an ex parrot") == "It is an ex parrot."
    assert format_phrase("This is already capitalised.") == "This is already capitalised."
